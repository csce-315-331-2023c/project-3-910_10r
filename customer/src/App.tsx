...
/**
 * main app that contains the customer, menuboard, payment and intro page
 */
function App() {
      ...
      <div>
        {
          isPayPage ? (
            ...
            <Cashier
              setPayPage={setIsPayPage}
              setMenuFalse={setIsMenu}
              setOrderFalse={setIsOrder}
            ></Cashier>
          ) : isMenu ? (
            <MenuBoard
              setMenuFalse={setIsMenu}
              setOrderFalse={setIsOrder}
              menuToOrderPage={setIsOrder}
            ></MenuBoard>
          ) : (
            <IntroPage
              isReadyToOrder={setIsOrder}
              isLookingAtMenu={setIsMenu}
            ></IntroPage>
          ) //If it is order, change page to "order"
