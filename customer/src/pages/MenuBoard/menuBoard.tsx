...
import ToOrderButton from "./toOrderButton.tsx";
...
/**
 * menu board for customer
 * @param {function} MenuBoardProps.setMenuFalse
 * @param {function} MenuBoardProps.setOrderFalse
 *  @param {function} MenuBoardProps.menuToOrderPage
 */
function MenuBoard({
  setMenuFalse,
  setOrderFalse,
            ...
            <div>
              {sweetnessLevels.map((level, index) => (
                <div key={index} className="sweetness-option">
                  <img
                    src={sweetnessImgs[index]}
                    alt="sweetness_icons"
                    width="400"
                    height="400"
                    className="sweetness_icons"
                  />
                  <p>{level}</p>
                </div>
              ))}
