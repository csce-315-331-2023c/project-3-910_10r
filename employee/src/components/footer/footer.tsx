      ...
      <div className="footer">
        ...
        <div className="accessibility">
          ...
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 998.1 998.3">
            <path fill={getComputedStyle(document.documentElement).getPropertyValue("--GREEN-DARK")} d="M931.7 998.3c36.5 0 66.4-29.4 66.4-65.4V265.8c0-36-29.9-65.4-66.4-65.4H283.6l260.1 797.9h388z"/>
